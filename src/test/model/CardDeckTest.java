...
public class CardDeckTest {
    ...
    @Test
    void getFCByFrontTest() {
        FlashCard testFlashCard2 = new FlashCard("f2", "b2", true);
        FlashCard testFlashCard3 = new FlashCard("f3", "b3", true);
        testDeck.addCard(testFlashCard);
        testDeck.addCard(testFlashCard2);
        testDeck.addCard(testFlashCard3);
        assertEquals(testFlashCard2,testDeck.getFlashCardByFront("f2"));
        assertEquals(testFlashCard3, testDeck.getFlashCardByFront("f3"));
        assertNull(testDeck.getFlashCardByFront("b2"));

    }

    @Test
    void getFCByBackTest() {
        FlashCard testFlashCard2 = new FlashCard("f2", "b2", true);
        FlashCard testFlashCard3 = new FlashCard("f3", "b3", true);
        testDeck.addCard(testFlashCard);
        testDeck.addCard(testFlashCard2);
        testDeck.addCard(testFlashCard3);
        assertEquals(testFlashCard2,testDeck.getFlashCardByBack("b2"));
        assertEquals(testFlashCard3,testDeck.getFlashCardByBack("b3"));
        assertNull(testDeck.getFlashCardByBack("f2"));
    }
    @Test
    void getFCTest(){
        FlashCard testFlashCard2 = new FlashCard("f2", "b2", true);
    ...
    @Test
    void getFlashCardNamesTest() {
        FlashCard testFlashCard2 = new FlashCard("f2", "b2", true);
        FlashCard testFlashCard3 = new FlashCard("f3", "b3", true);
        testDeck.addCard(testFlashCard);
        testDeck.addCard(testFlashCard2);
        testDeck.addCard(testFlashCard3);
        assertEquals("f1", testDeck.getFlashCardListFront().get(0));
        assertEquals("f2", testDeck.getFlashCardListFront().get(1));
        assertEquals("f3", testDeck.getFlashCardListFront().get(2));
